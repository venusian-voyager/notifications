...
class SendQueuedNotifications implements ShouldQueue
{
     ...
     *
     * @var \Voyager\Notifications\Notification
     */
    public $notification;
     ...
     *
     * @param  \Voyager\Notifications\Notifiable|\Voyager\NutsAndBolts\Collection  $notifiables
    ...
    protected function wrapNotifiables($notifiables)
    {
        if ($notifiables instanceof Collection) {
            ...
            return InstrumentCollection::wrap($notifiables);
        }
